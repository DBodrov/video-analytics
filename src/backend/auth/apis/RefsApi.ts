...
export interface RefsApiInterface {
     ...
     * @memberof RefsApiInterface
     */
    apiAuthRefsEventStatusesGetRaw(): Promise<runtime.ApiResponse<Array<object>>>;

    /**
     * # 
     * # Справочные сведения о статусах событий
     */
    apiAuthRefsEventStatusesGet(): Promise<Array<object>>;
...
export class RefsApi extends runtime.BaseAPI implements RefsApiInterface {
     ...
     * # Справочные сведения о статусах событий
     */
    async apiAuthRefsEventStatusesGetRaw(): Promise<runtime.ApiResponse<Array<object>>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * # Справочные сведения о статусах событий
     */
    async apiAuthRefsEventStatusesGet(): Promise<Array<object>> {
