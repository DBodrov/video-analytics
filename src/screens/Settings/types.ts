import {PipelinesGetResponse200Pipelines, PipelineSensorCheckGetResponse200} from '@/backend/main';
...
export type TPipelineSensorCheck = PipelineSensorCheckGetResponse200;
...
export type TPolygons = TPolygon[];
